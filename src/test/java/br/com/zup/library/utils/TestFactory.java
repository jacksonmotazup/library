...
import br.com.zup.library.usuario.NovoUsuarioRequest;
...
public class TestFactory {
    ...
    public static NovoUsuarioRequest criaNovoUsuarioPadrao() {
    ...
    public static NovoUsuarioRequest criaNovoUsuarioPesquisador() {
        var novoUsuarioRequest = new NovoUsuarioRequest();
        ReflectionTestUtils.setField(novoUsuarioRequest, TIPO_USUARIO, USUARIO_PESQUISADOR);
        return novoUsuarioRequest;
    }

    public static NovoUsuarioRequest criaNovoUsuarioEmBranco() {
        return new NovoUsuarioRequest();
    }

    public static NovoUsuarioRequest criaNovoUsuarioTipoInvalido() {
        var novoUsuarioRequest = new NovoUsuarioRequest();
